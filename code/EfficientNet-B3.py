# -*- coding: utf-8 -*-
"""
HAM10000 EfficientNet-B3 training script (Windows safe, GPU enabled)
"""
...
def initialize_model(model_name: str, num_classes: int,
    ...
    """
    只改模型：现在 model_name='efficientnet_b3' 时使用 EfficientNet-B3。
    其它训练流程完全不动。
    """
    model_ft = None
    input_size = 0
    ...
    if model_name == "efficientnet_b3":
        ...
        # EfficientNet-B3 的分类头在 classifier[1]
        num_ftrs = model_ft.classifier[1].in_features
        model_ft.classifier[1] = nn.Linear(num_ftrs, num_classes)

        # EfficientNet-B3 默认输入尺寸 300x300
        input_size = 300
    else:
...
def main():
    ...
    # ========== 10. 初始化模型 ==========
    model_name = "efficientnet_b3"   # 只改这里：使用 EfficientNet-B3
    ...
    # 改成 EfficientNet-B3 的模型文件名，避免和 ResNet 搞混
    best_model_path = "../best_efficientnet_b3_ham10000.pth"
